...
class AuthController extends ControllerBase
{
    ...
    private function handlePost()
    {
        ...
        // POST: /home/auth/change
        else if ($this->path_count == 3 && $this->path_parts[2] == "change") {
            $this->changeUser();
        }
        // POST: /home/auth/delete
    ...
    private function changeUser()
    {
        ...
        AuthService::updatePassword($this->user->user_id, $password);
    ...
    private function deleteUser()
    {
        ...
        UsersService::deleteUserByUsername($this->user->user_name);
