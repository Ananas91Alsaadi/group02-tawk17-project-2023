...
require_once __DIR__ . "/controllers/singleMovieController.php";
...
class FrontendRouter
{
    ...
    public function __construct($path_parts, $query_params)
    {
        ...
        $this->routes = [
            // Whenever someone calls "home/comments" we 
            // will load the commentPages class
            "home" => "HomeController",
            "auth" => "AuthController",
            "comments" => "commentController",
            "assets" => "AssetsController",
            "movies" => "movieController",
            "movie" => "singleMovieController"
    ...
    public function handleRequest()
    {
        ...
        if ($this->path_count >= 2 && $this->path_parts[1] != "") {
            // Get the requested resource from the URL such as "comments" or "Users"
